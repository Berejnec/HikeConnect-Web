  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(buttonVariants({ variant: "ghost" }), "h-8 w-8 p-0 font-normal aria-selected:opacity-100 w-full"),
        day_range_start: "day-range-start",
        day_range_end: "day-range-end",
        day_selected:
          "!bg-primary !text-slate-50 hover:!bg-green-600 hover:!text-slate-50 dark:!bg-slate-50 dark:!text-slate-900 dark:hover:!bg-slate-50 dark:hover:!text-slate-900 w-full",
        day_today: "bg-slate-100 text-slate-900 dark:bg-slate-800 dark:text-slate-50 w-full",
        day_outside:
